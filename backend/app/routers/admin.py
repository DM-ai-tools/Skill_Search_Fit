...
_CONFIG_META: dict[str, tuple[str, str]] = {
    ...
    "rate_limit_contact":                   ("rate_limits", "Max contact form submissions per window"),
    ...
    "openai_model":                         ("openai",      "OpenAI model ID"),
    "openai_max_tokens":                    ("openai",      "Default max output tokens"),
